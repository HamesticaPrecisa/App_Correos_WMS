...
Public Class Rpt_PedidosWeb
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaEnvioCorreos.Web.Rpt_PedidosWeb.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PedidosWeb
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PedidosWeb = New Rpt_PedidosWeb()
        rpt.Site = Me.Site
        Return rpt
    End Function
