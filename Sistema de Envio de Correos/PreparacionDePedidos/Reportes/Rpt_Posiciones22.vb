...
Public Class Rpt_Posiciones22
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaEnvioCorreos.Web.Rpt_Posiciones22.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Posiciones22
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Posiciones22 = New Rpt_Posiciones22()
        rpt.Site = Me.Site
        Return rpt
    End Function
