...
Public Class Rpt_PedidosSemanal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaEnvioCorreos.Web.Rpt_PedidosSemanal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PedidosSemanal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PedidosSemanal = New Rpt_PedidosSemanal()
        rpt.Site = Me.Site
        Return rpt
    End Function
