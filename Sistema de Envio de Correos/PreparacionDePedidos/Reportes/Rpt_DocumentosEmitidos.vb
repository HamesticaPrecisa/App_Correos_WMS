...
Public Class Rpt_DocumentosEmitidos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_DocumentosEmitidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaEnvioCorreos.Web.Rpt_DocumentosEmitidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_DocumentosEmitidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_DocumentosEmitidos = New Rpt_DocumentosEmitidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
